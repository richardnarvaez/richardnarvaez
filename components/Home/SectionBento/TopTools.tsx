    ...
    <>
      <Link href="#tools">
        <div className="group relative flex h-full items-center justify-center overflow-hidden rounded-3xl border text-center">
          ...
          <div className="absolute inset-0 z-10 size-full bg-black/50" />

          <Image
            alt=""
            className="absolute inset-0 size-full object-cover opacity-75 transition-all ease-out group-hover:scale-110 group-hover:blur-sm"
            src={
